      ...
      <div className="container mx-auto py-12">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-lg">
            <li>
              <strong>Frontend Developer</strong> - We are looking for a
              talented Frontend Developer to join our team. You will be
              responsible for building responsive, user-friendly websites and
              applications.
        ...
        <section className="mb-8">
          ...
          <p className="text-lg mb-4">
            ...
            innovators, we'd love to hear from you! To apply, please send us
