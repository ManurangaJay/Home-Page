  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-lg">
          Our mission is to bring you innovative solutions that meet the highest
          standards. We aim to create lasting value for our customers by
          delivering top-notch products and services while fostering a culture
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-lg">
          <li>
            Customer-Centric: We put the customer at the center of everything we
            do.
          </li>
          <li>
          ...
          <li>
            Innovation: We are committed to continuously improving and adapting
            to changing needs.
          </li>
          <li>
      ...
      <section>
        ...
        <p className="text-lg">
          Our team is composed of passionate individuals with diverse skill sets
          working together to drive innovation and excellence. Each member
          brings unique expertise to the table, contributing to our collective
          success.
        </p>
