    ...
    <div>
      <div className="container mx-auto py-12">
        ...
        <p className="text-lg mb-6">
          At our company, we value your privacy. This privacy policy outlines
        ...
        <p className="text-lg mb-4">
          ...
          experience on our website, process orders, and provide customer
          support. The information we collect includes:
        </p>
        <ul className="list-disc ml-6 mb-4 text-lg">
          ...
          <li>
            Billing and shipping information (credit card details, address)
          </li>
          <li>
            Usage data (browsing activity, device information, IP address)
          </li>
        </ul>
        ...
        <p className="text-lg mb-4">
          ...
          user experience. Cookies are small text files stored on your device
          that allow us to recognize you and remember your preferences. You can
          control your cookie settings through your browser, but disabling
        ...
        <p className="text-lg mb-4">
          ...
          concerns about how your data is being used, please contact us using
        ...
        <ul className="list-disc ml-6 mb-4 text-lg">
          ...
          <li>
            Objection: Object to the processing of your data for certain
            purposes
          </li>
        </ul>
